---
name: eagle-gate
description: "在计划、执行、测试、审查和完成前检查最小必要质量门禁。 Use this Codex skill when the user asks for the matching Eagle workflow or explicitly invokes $eagle-gate."
---
...
Codex invocation: `$eagle-gate`. Legacy Claude slash-command examples are preserved below for workflow compatibility.
