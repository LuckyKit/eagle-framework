---
name: eagle-new-project
description: "纯脚手架工具：创建目录结构、复制编码规范、生成骨架文件。 Use this Codex skill when the user asks for the matching Eagle workflow or explicitly invokes $eagle-new-project."
---
...
Codex invocation: `$eagle-new-project`. Legacy Claude slash-command examples are preserved below for workflow compatibility.
