---
name: eagle-tester
description: "原子 Skill。只负责一件事：执行测试，输出 TEST.md。 Use this Codex skill when the user asks for the matching Eagle workflow or explicitly invokes $eagle-tester."
---
...
Codex invocation: `$eagle-tester`. Legacy Claude slash-command examples are preserved below for workflow compatibility.
...
5. **测试命令优先来自 TESTING.md** — 若自动检测命令与地图冲突，说明原因并更新建议
