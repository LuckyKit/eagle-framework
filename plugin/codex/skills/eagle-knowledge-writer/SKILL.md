...
description: "原子 Skill。只负责一件事：任务完成后沉淀知识和记忆。 Use this Codex skill when the user asks for the matching Eagle workflow or explicitly invokes $eagle-knowledge-writer."
---

# eagle-knowledge-writer

<!-- Generated from plugin/claude. Run `npm run sync:codex` after editing Claude skills. -->

Codex invocation: `$eagle-knowledge-writer`. Legacy Claude slash-command examples are preserved below for workflow compatibility.
