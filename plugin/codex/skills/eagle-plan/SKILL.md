---
name: eagle-plan
description: "原子 Skill。只负责一件事：读取 DISCUSSION.md，生成 Phase + Wave 计划，输出 PLAN.md。 Use this Codex skill when the user asks for the matching Eagle workflow or explicitly invokes $eagle-plan."
---
...
Codex invocation: `$eagle-plan`. Legacy Claude slash-command examples are preserved below for workflow compatibility.
...
- Wave 必须标注：涉及的栈（go / python / nextjs / flutter）、依赖的其他 Wave
